...
var encodedProperties = ['url', 'user_agent', 'bg_color', 'hide_selector', 'click_selector', 'highlight', 'highlightbg', 'highlightfg', 's3_path'];

var booleanProperties = ['force', 'flash', 'retina', 'full_page', 'disable_js', 'use_s3', 'debug'];
